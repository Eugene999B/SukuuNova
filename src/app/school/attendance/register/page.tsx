...
export default async function AttendanceRegisterPage({ searchParams }: { searchParams?: Promise<{ classId?: string; date?: string }> }) {
  ...
  return <AppShell universe="school" title="Class Attendance Register" subtitle="Class roster." active="Student Attendance" schoolName={data.school.name} schoolCode={data.school.uniqueCode} userName={session.name}>
    <div className="module-workspace">
      ...
      {!data.selectedClass ? <section className="module-card"><strong>No class selected</strong><Link className="button primary" href="/school/classes">Go to classes</Link></section> : null}
    </div>
