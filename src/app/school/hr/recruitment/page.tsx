...
export default async function RecruitmentPage() {
  ...
  if (!school) notFound();
  return <AppShell universe="school" title="Talent & Recruitment" subtitle="Recruitment." active="Recruitment" schoolName={school.name} schoolCode={school.uniqueCode} userName={session.name}><div className="school-life-surface"><SchoolLifeStudio module="recruitment" schoolName={school.name} userName={session.name} schoolId={session.schoolId} /></div></AppShell>;
}
