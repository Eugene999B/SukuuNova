...
import { ArrowRight, BookOpenCheck, ClipboardCheck, GraduationCap, ShieldCheck, SlidersHorizontal } from "lucide-react";
...
export default async function GradebookPage(){
  ...
  return <AppShell universe="school" title="Gradebook" subtitle="Results hub." active="Gradebook"><div className="gradebook-shell"><section className="gradebook-hero"><div><span className="gradebook-kicker">RESULTS CONTROL CENTRE</span><h2>{data.canModerate?"See the school-wide result picture.":"Keep your results accurate and on time."}</h2></div><div className="gradebook-hero-actions"><Link className="gradebook-primary" href="/school/teacher-academic"><BookOpenCheck size={14} aria-hidden="true" /> Teacher Academic Studio <ArrowRight size={14} aria-hidden="true" /></Link><Link className="gradebook-secondary" href="/school/gradebook/studio">Classic Gradebook <ArrowRight size={14} aria-hidden="true" /></Link>{data.canModerate?<Link className="gradebook-secondary" href="/school/academics/performance">Performance Studio <SlidersHorizontal size={14} aria-hidden="true" /></Link>:null}</div></section><section className="gradebook-kpis"><article><span className="gradebook-kpi-icon"><GraduationCap size={16} aria-hidden="true" /></span><span>Teaching links</span><strong>{data.assignments}</strong><small>{data.canModerate?"School assignments":"Your assigned class-subject links"}</small></article><article><span className="gradebook-kpi-icon"><ClipboardCheck size={16} aria-hidden="true" /></span><span>Assessments</span><strong>{data.assessmentCount}</strong><small>Assessment records in the school</small></article><article><span className="gradebook-kpi-icon"><GraduationCap size={16} aria-hidden="true" /></span><span>Active learners</span><strong>{data.studentCount}</strong><small>Current learner population</small></article><article><span className="gradebook-kpi-icon"><ShieldCheck size={16} aria-hidden="true" /></span><span>Terms</span><strong>{data.termCount}</strong><small>Available academic periods</small></article></section><section className="gradebook-grid"><article className="gradebook-card"><span className="gradebook-kicker">01 · ENTER</span><h3>Teacher Academic Studio</h3><p>Weekly work, fast mark entry, question-based activities and class notes.</p><Link href="/school/teacher-academic" className="gradebook-link">Open teacher studio <ArrowRight size={14} aria-hidden="true" /></Link></article><article className="gradebook-card"><span className="gradebook-kicker">02 · ENTER</span><h3>Gradebook Studio</h3><Link href="/school/gradebook/studio" className="gradebook-link">Open mark entry <ArrowRight size={14} aria-hidden="true" /></Link></article><article className="gradebook-card"><span className="gradebook-kicker">03 · ANALYSE</span><h3>Performance Studio</h3><Link href="/school/academics/performance" className="gradebook-link">Analyse performance <ArrowRight size={14} aria-hidden="true" /></Link></article><article className="gradebook-card"><span className="gradebook-kicker">04 · PREPARE</span><h3>Report-card chain</h3><p>Results become reporting evidence after the school’s assessment and term rules are satisfied.</p><Link href="/school/report-cards" className="gradebook-link">Open report cards <ArrowRight size={14} aria-hidden="true" /></Link></article></section><section className="gradebook-footer"><div><b>Role boundary</b></div><Link href="/school/settings/access">Manage role boundaries <ArrowRight size={14} aria-hidden="true" /></Link></section></div></AppShell>}
