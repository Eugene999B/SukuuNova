...
.report-cards-page{width:100%;max-width:1540px;margin:0 auto;padding:6px 0 34px;color:var(--report-ink,var(--sn-ink))}
...
.report-eyebrow{display:flex;align-items:center;gap:8px;font-size:10px;font-weight:900;letter-spacing:.16em;text-transform:uppercase;color:var(--sn-ink)}
.report-eyebrow i{font-style:normal;color:var(--sn-ink)}
.report-notice{display:flex;align-items:center;gap:10px;padding:11px 14px;border-radius:14px;border:1px solid var(--sn-line);background:var(--sn-surface);color:var(--sn-ink);font-size:11px;font-weight:800;margin-bottom:14px}
...
.report-hero-copy{position:relative;overflow:hidden;padding:28px 30px;border:1px solid var(--sn-line);border-radius:24px;background:radial-gradient(circle at 86% 18%,var(--sn-surface),transparent 31%),linear-gradient(135deg,var(--sn-surface),var(--sn-surface));box-shadow:0 22px 65px var(--sn-shadow-sm)}
.report-hero-copy:after{content:"";position:absolute;width:280px;height:280px;right:-150px;bottom:-180px;border-radius:50%;border:1px solid var(--sn-line)}
.report-hero-copy h1{max-width:760px;margin-top:11px;font-size:38px;line-height:1.03;letter-spacing:-.045em;color:var(--sn-ink)}
.report-hero-copy p{max-width:740px;margin-top:12px;font-size:13px;line-height:1.75;color:var(--sn-ink)}
...
.report-primary-link{background:var(--sn-surface);color:var(--sn-ink);box-shadow:0 12px 24px var(--sn-shadow-sm)}
.report-secondary-link{border:1px solid var(--sn-line);background:var(--sn-surface);color:var(--sn-ink)}
...
.report-hero-visual{display:flex;align-items:center;justify-content:center;gap:20px;min-height:220px;padding:24px;border-radius:24px;border:1px solid var(--sn-line);background:linear-gradient(150deg,var(--sn-surface),var(--sn-surface))}
.report-ring{--progress:0%;width:150px;height:150px;flex:none;display:grid;place-items:center;border-radius:50%;background:conic-gradient(var(--sn-surface) var(--progress),var(--sn-surface) 0)}
.report-ring:before{content:"";width:114px;height:114px;border-radius:50%;background:var(--sn-surface);border:1px solid var(--sn-line);grid-area:1/1}
.report-ring>div{grid-area:1/1;display:flex;flex-direction:column;align-items:center;position:relative;z-index:1}
.report-ring strong{font-size:31px;line-height:1;letter-spacing:-.05em;color:var(--sn-ink)}
.report-ring span{margin-top:5px;color:var(--sn-ink);font-size:9px;text-transform:uppercase;letter-spacing:.14em;font-weight:900}
.report-hero-visual-copy{min-width:0}.report-hero-visual-copy>span{display:block;color:var(--sn-ink);font-size:9px;font-weight:900;letter-spacing:.15em}.report-hero-visual-copy>strong{display:block;margin-top:8px;font-size:18px;letter-spacing:-.025em;color:var(--sn-ink)}.report-hero-visual-copy>small{display:block;margin-top:8px;color:var(--sn-ink);font-size:10px;line-height:1.5}
.report-context-card{display:grid;grid-template-columns:minmax(220px,.65fr) minmax(0,1.35fr);gap:18px;align-items:end;padding:16px;border:1px solid var(--sn-line);border-radius:20px;background:var(--sn-surface);margin-bottom:14px}
.report-context-label{min-width:0;padding:0 4px 3px}.report-context-label strong{display:block;margin-top:5px;color:var(--sn-ink);font-size:17px;letter-spacing:-.025em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.report-context-label small{display:block;margin-top:4px;color:var(--sn-ink);font-size:9px}
.report-selects{display:grid;grid-template-columns:1fr 1.2fr auto;gap:8px;align-items:end}.report-selects label{display:grid;gap:6px}.report-selects label>span{font-size:9px;font-weight:850;color:var(--sn-ink);text-transform:uppercase;letter-spacing:.11em}.report-selects select{width:100%;height:40px;padding:0 12px;border:1px solid var(--sn-line);border-radius:11px;background:var(--sn-surface);color:var(--sn-ink);font-size:10px}.report-button{border:0;cursor:pointer}.report-button.primary{background:var(--sn-surface);color:var(--sn-ink)}.report-button:disabled{opacity:.5;cursor:not-allowed;transform:none}
.report-empty-state{display:grid;justify-items:center;text-align:center;min-height:330px;padding:44px 24px;border-radius:24px;border:1px dashed var(--sn-line);background:linear-gradient(145deg,var(--sn-surface),var(--sn-surface))}.report-empty-state.compact{min-height:250px;margin-top:6px}.report-empty-state h1,.report-empty-state h2{margin-top:12px;color:var(--sn-ink);letter-spacing:-.035em}.report-empty-state h1{font-size:24px}.report-empty-state h2{font-size:20px}.report-empty-state p{max-width:560px;margin-top:8px;color:var(--sn-ink);font-size:11px;line-height:1.7}.report-empty-icon{width:54px;height:54px;display:grid;place-items:center;border-radius:17px;border:1px solid var(--sn-line);background:var(--sn-surface);color:var(--sn-ink)}.report-empty-icon svg{width:24px;height:24px}.report-empty-state .report-primary-link{margin-top:16px}
.report-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-bottom:14px}.report-metric{display:flex;align-items:center;gap:12px;padding:16px;border:1px solid var(--sn-line);border-radius:18px;background:linear-gradient(145deg,var(--sn-surface),var(--sn-surface))}.report-metric.feature{background:linear-gradient(135deg,var(--sn-surface),var(--sn-surface));border-color:var(--sn-line)}.report-metric-icon{width:38px;height:38px;display:grid;place-items:center;flex:none;border-radius:12px;background:var(--sn-surface);color:var(--sn-ink)}.report-metric-icon svg{width:18px;height:18px}.report-metric span,.report-metric small{display:block}.report-metric span{color:var(--sn-ink);font-size:8px;font-weight:900;letter-spacing:.1em;text-transform:uppercase}.report-metric strong{display:block;margin-top:4px;font-size:24px;line-height:1;letter-spacing:-.04em;color:var(--sn-ink)}.report-metric strong em{font-style:normal;color:var(--sn-ink);font-size:11px;margin-left:2px}.report-metric small{margin-top:5px;color:var(--sn-ink);font-size:8px}
.report-command-grid{display:grid;grid-template-columns:minmax(0,1.5fr) minmax(330px,.72fr);gap:12px;margin-bottom:14px}.report-command-card,.report-side-card,.report-queue-card{border:1px solid var(--sn-line);border-radius:20px;background:linear-gradient(145deg,var(--sn-surface),var(--sn-surface))}.report-command-card{position:relative;padding:22px}.report-command-number{position:absolute;right:20px;top:16px;font-size:55px;line-height:1;font-weight:950;letter-spacing:-.06em;color:var(--sn-ink)}.report-command-copy{max-width:650px}.report-command-copy h2{margin-top:6px;color:var(--sn-ink);font-size:21px;letter-spacing:-.035em}.report-command-copy p{max-width:600px;margin-top:7px;color:var(--sn-ink);font-size:10px;line-height:1.65}.report-command-progress{display:grid;grid-template-columns:minmax(0,1fr) auto auto;gap:9px;align-items:center;margin-top:18px}.report-progress-track{height:8px;overflow:hidden;border-radius:999px;background:var(--sn-surface)}.report-progress-track span{display:block;height:100%;border-radius:999px;background:linear-gradient(90deg,var(--sn-surface),var(--sn-surface));box-shadow:0 0 18px var(--sn-shadow-sm)}.report-command-progress strong{font-size:11px;color:var(--sn-ink)}.report-command-progress small{color:var(--sn-ink);font-size:9px}.report-command-actions{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-top:18px}.report-command-actions form{margin:0}.report-command-actions .report-secondary-link{min-height:40px}
.report-side-card{padding:19px}.report-pipeline{display:grid;grid-template-columns:1fr auto 1fr auto 1fr auto 1fr;gap:7px;align-items:center;margin-top:15px}.report-pipeline>div{min-width:0;padding:9px;border-radius:12px;border:1px solid var(--sn-line);background:var(--sn-surface)}.report-pipeline>div.is-active{border-color:var(--sn-line);background:var(--sn-surface)}.report-pipeline div span{display:block;color:var(--sn-ink);font-size:7px;font-weight:900}.report-pipeline div strong{display:block;margin-top:5px;color:var(--sn-ink);font-size:8px;white-space:nowrap}.report-pipeline div small{display:block;margin-top:3px;color:var(--sn-ink);font-size:7px}.report-pipeline i{font-style:normal;color:var(--sn-ink);text-align:center}
.report-queue-card{overflow:hidden}.report-queue-head{display:flex;align-items:flex-start;justify-content:space-between;gap:20px;padding:21px 22px;border-bottom:1px solid var(--sn-line)}.report-queue-head h2{margin-top:5px;color:var(--sn-ink);font-size:21px;letter-spacing:-.035em}.report-queue-head p{margin-top:5px;color:var(--sn-ink);font-size:10px}.report-queue-summary{text-align:right}.report-queue-summary strong{display:block;color:var(--sn-ink);font-size:25px;letter-spacing:-.05em}.report-queue-summary span{color:var(--sn-ink);font-size:8px;text-transform:uppercase;letter-spacing:.12em;font-weight:900}
.report-learner-list{display:grid}.report-learner-row{display:grid;grid-template-columns:auto minmax(0,1fr) minmax(95px,.18fr) auto;gap:14px;align-items:center;padding:14px 18px;border-bottom:1px solid var(--sn-line)}.report-learner-row:last-child{border-bottom:0}.report-learner-row:hover{background:var(--sn-surface)}.report-learner-avatar{width:40px;height:40px;display:grid;place-items:center;border-radius:13px;background:linear-gradient(145deg,var(--sn-surface),var(--sn-surface));border:1px solid var(--sn-line);color:var(--sn-ink);font-size:10px;font-weight:950}.report-learner-main{min-width:0}.report-learner-name{display:flex;align-items:baseline;gap:9px;min-width:0}.report-learner-name strong{color:var(--sn-ink);font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.report-learner-name span{color:var(--sn-ink);font-size:8px;white-space:nowrap}.report-status-line{display:flex;align-items:center;gap:7px;margin-top:6px}.report-status-icon{width:20px;height:20px;display:grid;place-items:center;border-radius:7px;background:var(--sn-surface);color:var(--sn-ink)}.report-status-icon svg{width:11px;height:11px}.status-draft .report-status-icon{color:var(--sn-ink)}.status-submitted .report-status-icon{color:var(--color-warning)}.status-approved .report-status-icon{color:var(--color-info)}.status-sent .report-status-icon{color:var(--sn-ink)}.report-status-line b{display:block;color:var(--sn-ink);font-size:8px}.report-status-line small{display:block;margin-top:2px;color:var(--sn-ink);font-size:7px}.report-learner-date{text-align:right}.report-learner-date span{display:block;color:var(--sn-ink);font-size:7px;letter-spacing:.11em;font-weight:900}.report-learner-date strong{display:block;margin-top:4px;color:var(--sn-ink);font-size:8px}.report-learner-actions{display:flex;align-items:center;justify-content:flex-end;gap:7px;min-width:190px}.report-learner-actions form{margin:0}.report-row-link,.report-row-action{display:inline-flex;align-items:center;justify-content:center;gap:7px;min-height:34px;padding:0 10px;border-radius:10px;font-size:8px;font-weight:900;transition:transform .18s ease}.report-row-link{border:1px solid var(--sn-line);color:var(--sn-ink);background:var(--sn-surface)}.report-row-action{border:1px solid var(--sn-line);background:var(--sn-surface);color:var(--sn-ink);cursor:pointer}.status-sent .report-row-action{display:none}
.report-list-empty{display:grid;justify-items:center;text-align:center;padding:50px 24px}.report-list-empty .report-empty-icon{margin-bottom:10px}.report-list-empty strong{color:var(--sn-ink);font-size:12px}.report-list-empty span{margin-top:5px;color:var(--sn-ink);font-size:9px}
.report-footer-rail{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:10px;margin-top:14px;padding:13px 15px;border-radius:16px;border:1px solid var(--sn-line);background:var(--sn-surface)}.report-footer-rail>div{display:flex;align-items:center;gap:10px}.report-footer-rail>div>svg{width:17px;height:17px;color:var(--sn-ink)}.report-footer-rail strong,.report-footer-rail small{display:block}.report-footer-rail strong{color:var(--sn-ink);font-size:9px}.report-footer-rail small{margin-top:3px;color:var(--sn-ink);font-size:7px}.report-footer-rail a{display:inline-flex;align-items:center;gap:7px;padding:9px 10px;border-radius:10px;color:var(--sn-ink);font-size:8px;font-weight:850;background:var(--sn-surface);border:1px solid var(--sn-line)}

:root[data-theme="light"] .report-cards-page{--report-ink:var(--color-surface-raised);color:var(--sn-ink)}
:root[data-theme="light"] .report-hero-copy{background:radial-gradient(circle at 88% 16%,var(--sn-surface),transparent 31%),linear-gradient(135deg,var(--sn-surface),var(--sn-surface));border-color:var(--sn-line);box-shadow:0 18px 50px var(--sn-shadow-sm)}
:root[data-theme="light"] .report-hero-copy h1,:root[data-theme="light"] .report-command-copy h2,:root[data-theme="light"] .report-queue-head h2,:root[data-theme="light"] .report-empty-state h1,:root[data-theme="light"] .report-empty-state h2,:root[data-theme="light"] .report-metric strong,:root[data-theme="light"] .report-learner-name strong{color:var(--sn-ink)}
:root[data-theme="light"] .report-hero-copy p,:root[data-theme="light"] .report-command-copy p,:root[data-theme="light"] .report-queue-head p,:root[data-theme="light"] .report-empty-state p{color:var(--sn-ink)}
:root[data-theme="light"] .report-hero-visual,.report-cards-page:where(:root[data-theme="light"]) .report-context-card,:root[data-theme="light"] .report-command-card,:root[data-theme="light"] .report-side-card,:root[data-theme="light"] .report-queue-card,:root[data-theme="light"] .report-metric,:root[data-theme="light"] .report-footer-rail{background:linear-gradient(145deg,var(--sn-surface),var(--sn-surface));border-color:var(--sn-line);box-shadow:0 12px 35px var(--sn-shadow-sm)}
:root[data-theme="light"] .report-context-label strong,:root[data-theme="light"] .report-selects select{color:var(--sn-ink)}
:root[data-theme="light"] .report-selects select{background:var(--sn-surface);border-color:var(--sn-line)}
:root[data-theme="light"] .report-ring:before{background:var(--sn-surface);border-color:var(--sn-line)}
:root[data-theme="light"] .report-hero-visual-copy>strong{color:var(--sn-ink)}
:root[data-theme="light"] .report-pipeline>div{background:var(--sn-surface);border-color:var(--sn-line)}
:root[data-theme="light"] .report-pipeline>div.is-active{background:var(--color-success-soft);border-color:var(--sn-line)}
:root[data-theme="light"] .report-pipeline div strong{color:var(--sn-ink)}
:root[data-theme="light"] .report-learner-row{border-bottom-color:var(--sn-line)}
:root[data-theme="light"] .report-learner-row:hover{background:var(--sn-surface)}
:root[data-theme="light"] .report-learner-name span,:root[data-theme="light"] .report-learner-date strong,:root[data-theme="light"] .report-status-line small{color:var(--sn-ink)}
:root[data-theme="light"] .report-row-link,:root[data-theme="light"] .report-secondary-link{background:var(--sn-surface);border-color:var(--sn-line);color:var(--sn-ink)}
:root[data-theme="light"] .report-footer-rail a{background:var(--sn-surface);border-color:var(--sn-line);color:var(--sn-ink)}
