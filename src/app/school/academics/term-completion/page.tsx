    ...
    <main style={{ minHeight: "100vh", background: "#07121b", color: "#edf8f5", padding: 24 }}>
      <div style={{ maxWidth: 1120, margin: "0 auto" }}>
        ...
        <section style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14, marginTop: 24 }}>
          <div style={{ borderRadius: 18, padding: 18, border: "1px solid rgba(255,255,255,.08)", background: "rgba(255,255,255,.025)" }}><b>1</b><h3>Choose the term</h3></div>
          <div style={{ borderRadius: 18, padding: 18, border: "1px solid rgba(255,255,255,.08)", background: "rgba(255,255,255,.025)" }}><b>2</b><h3>Run readiness</h3></div>
          <div style={{ borderRadius: 18, padding: 18, border: "1px solid rgba(255,255,255,.08)", background: "rgba(255,255,255,.025)" }}><b>3</b><h3>Resolve & publish</h3></div>
        </section>
