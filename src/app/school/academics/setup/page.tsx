  ...
  >
    <div className="academic-page">
      <section className="academic-page-hero">
        ...
        <div className="academic-page-hero-side"><div className="academic-page-context"><span className="academic-context-chip"><strong>School</strong> {school?.name ?? "Current school"}</span><span className="academic-context-chip"><strong>Controls</strong> Calendar · timetable · grading · reports</span></div><div className="academic-page-actions"><Link className="academic-btn-secondary" href="/school/terms">Academic Terms</Link><Link className="academic-btn-secondary" href="/school/academics/health">Readiness</Link></div></div>
      </section>
