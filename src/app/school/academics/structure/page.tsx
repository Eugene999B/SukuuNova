...
export default async function AcademicStructurePage() {
  ...
  return <AppShell universe="school" title="School Structure" subtitle="Define grades, sections, pathways and year-to-year progression." active="Academic Settings" schoolName={data.school.name} schoolCode={data.school.uniqueCode} userName={session.name} role="Academic leadership">
