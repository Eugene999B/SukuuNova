...
import { getClassSubjectPerformance, getGradebookConfiguration } from "@/lib/academic-engine";
    ...
    <div className="academic-page">
      <section className="academic-page-hero">
        <div className="academic-page-hero-copy">
          <span className="academic-page-overline">PERFORMANCE · REVIEW & DECIDE</span>
          <h1>Turn the gradebook into a result picture people can act on.</h1>
          <p>{mode}. The page uses the same class, subject, term and weighted result that teachers work with in Gradebook, so review does not become a second source of truth.</p>
        </div>
        <div className="academic-page-hero-side">
          <div className="academic-page-context"><span className="academic-context-chip"><strong>Class</strong> {classLabel}</span><span className="academic-context-chip"><strong>Subject</strong> {subjectLabel}</span><span className="academic-context-chip"><strong>Term</strong> {data.term?.name ?? "Choose a term"}</span></div>
          <div className="academic-page-actions"><Link className="academic-btn-secondary" href={`/school/gradebook/studio${contextQuery}`}>Open gradebook</Link><Link className="academic-btn-secondary" href="/school/report-cards">Report cards</Link></div>
        </div>
      </section>
