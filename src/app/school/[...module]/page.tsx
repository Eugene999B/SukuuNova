...
function SearchCentre({schoolName,sessionName,teacherMode}:{schoolName:string;sessionName:string;teacherMode:boolean}) {
  ...
  return <AppShell universe={teacherMode ? "teacher" : "school"} title="Search" subtitle="Browse." active="Search" schoolName={schoolName} userName={sessionName}>
