...
const definitions: Record<string, Definition> = {
  ...
  "students": { title: "Students", description: "Build and manage your student register, profiles, class placement and family links.", action: "Add a student", actionHref: "/mvp" },
  ...
  "staff": { title: "Staff & Teachers", description: "Manage teachers, administrators, support staff and their access to SukuuNova.", action: "Open staff workspace", actionHref: "/phase2" },
  ...
  "timetable": { title: "Timetable", description: "Plan lessons, teaching periods, rooms and staff schedules.", action: "Open timetable", actionHref: "/phase2" },
  ...
  "gradebook": { title: "Gradebook", description: "Record learner marks and monitor academic performance by class and subject.", action: "Open gradebook", actionHref: "/mvp" },
  ...
  "attendance": { title: "Student Attendance", description: "Take daily registers and review attendance history by learner or class.", action: "Mark attendance", actionHref: "/phase3" },
  "staff-attendance": { title: "Staff Attendance", description: "Track staff presence, lateness and attendance history.", action: "Open staff attendance", actionHref: "/phase2" },
  "attendance/exceptions": { title: "Late / Absence", description: "Review attendance exceptions and follow up on unexplained absences.", action: "Review exceptions", actionHref: "/school/attendance" },
  ...
  "fees": { title: "School Fees", description: "Configure fees and the charges your school expects learners to pay.", action: "Configure fees", actionHref: "/phase3" },
  ...
  "fees/payments": { title: "Payments", description: "Record and review school fee payments and receipts.", action: "Record payment", actionHref: "/phase3" },
  ...
  "settings/roles": { title: "Roles & Permissions", description: "Control who can see and act on each part of the school workspace.", action: "Manage roles", actionHref: "/phase2/roles" },
  "settings": { title: "School Settings", description: "Configure your school profile, operational preferences, term structure and integrations.", action: "Open settings", actionHref: "/phase2" },
