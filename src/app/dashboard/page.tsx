...
function SchoolRoleDashboard({ name, school, code, role, profile, stats }: { name: string; school: string; code: string; role: string; profile: DashboardProfile; stats: SchoolStats }) {
  ...
  const actionsByProfile: Record<DashboardProfile, IntelligenceAction[]> = {
    ...
    academics: [
      { label: "Academic setup", detail: "Classes, subjects, teachers and terms.", href: "/school/academics/setup" }, { label: "Timetable", detail: "Generate or review the official schedule.", href: "/school/timetable" }, { label: "Gradebook", detail: "Monitor assessment and marks.", href: "/school/gradebook" }, { label: "Report cards", detail: "Review reporting workflow.", href: "/school/report-cards" },
    ],
    people: [
