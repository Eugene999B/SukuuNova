...
export default async function GuardianMessagesPage(){
 ...
 return <AppShell universe="guardian" title="Messages" subtitle="School messages and direct family communication." active="Messages" schoolName={school.name} schoolCode={school.uniqueCode} userName={session.name} role="Guardian"><GuardianMessagesDesk/></AppShell>;
}
