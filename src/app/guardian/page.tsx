...
export default async function GuardianPortalPage() {
  ...
  return <AppShell universe="guardian" title="Family dashboard" subtitle="Your children, fees and updates." active="Overview" schoolName={session.schoolName} schoolCode="" userName={data.guardian.name} role="Guardian">
    <div className="guardian-command-center">
      <section className="guardian-hero app-card"><div><span className="guardian-eyebrow">Family workspace</span><h2>Good morning, {data.guardian.name.split(/\s+/)[0] || data.guardian.name}.</h2><p>Choose a child or task.</p></div><div className="guardian-balance"><span>Family balance</span><strong>GH₵{familyBalance.toFixed(2)}</strong><Link href="/guardian/fees">View fees <ArrowRight size={13} aria-hidden="true" /></Link></div></section>
      <section className="guardian-task-grid">
        <Link href="/guardian/arcade" className="guardian-task-card"><span className="guardian-task-icon"><GraduationCap size={18} aria-hidden="true" /></span><div><strong>Learning Arcade</strong><span>Math, words and logic · separate progress for each child</span></div><ArrowRight size={16} aria-hidden="true" /></Link>
        ...
        <Link href="/guardian/academics" className="guardian-task-card"><span className="guardian-task-icon"><GraduationCap size={18} aria-hidden="true" /></span><div><strong>Recent results</strong></div><ArrowRight size={16} aria-hidden="true" /></Link>
        <Link href="/guardian/messages" className="guardian-task-card"><span className="guardian-task-icon"><Mail size={18} aria-hidden="true" /></span><div><strong>Messages</strong></div><ArrowRight size={16} aria-hidden="true" /></Link>
        <Link href="/guardian/fees" className="guardian-task-card"><span className="guardian-task-icon"><WalletCards size={18} aria-hidden="true" /></span><div><strong>Fees & receipts</strong></div><ArrowRight size={16} aria-hidden="true" /></Link>
      </section>
