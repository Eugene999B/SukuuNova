export default function CompactIdentityCardVerificationLoading() {
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-10 text-white sm:px-6">
      <div className="mx-auto max-w-xl rounded-[28px] border border-white/15 bg-white/10 p-6 shadow-2xl backdrop-blur sm:p-8" role="status" aria-live="polite">
        ...
        <p className="mt-5 text-sm leading-6 text-slate-300">The signed QR, issuing school, holder and current credential status are being checked against the live school record.</p>
      </div>
    </main>
  );
}
