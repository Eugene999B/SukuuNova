...
import { BellRing, Building2, CheckCircle2, Home, Save, ShieldCheck, UserCog } from "lucide-react";
...
export default function AccountSettingsPage() {
  ...
  return (
    <main className="settings-hub" style={{ maxWidth: "var(--sn-page-max)", margin: "0 auto", padding: "var(--sn-content-pad)" }}>
      <SettingsHero
        eyebrow="My account"
