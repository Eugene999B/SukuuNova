...
export default function ArcadeGameLogo({ game, size = "card" }: Props) {
  ...
  if (game === "logic") return root("Nova Millionaire logo", <><Crown className="arcade-mark-main" aria-hidden="true"/><Sparkles className="arcade-mark-core" aria-hidden="true"/><span className="arcade-mark-star" aria-hidden="true"><Zap size={13}/></span></>, "arcade-mark-millionaire");
  ...
  if (game === "space-explorer") return root("Solar Navigator Mission Control logo", <><Orbit className="arcade-mark-orbit" aria-hidden="true"/><Rocket className="arcade-mark-main" aria-hidden="true"/><span className="arcade-mark-star" aria-hidden="true"><Sparkles size={13}/></span></>, "arcade-mark-solar");
