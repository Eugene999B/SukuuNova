  ...
  return <section className="teacher-real-workspace">
    ...
    {tab === "gradebook" && <div className="teacher-real-grid">
      <article className="teacher-real-card">
        <div className="teacher-real-card-head"><div><span>MARK ENTRY</span><h3>{selectedAssignment ? classLabel(selectedAssignment) : "No teaching assignment"}</h3><p>Only learners in your selected class and subject are displayed.</p></div><button type="button" onClick={() => void loadGradebook()} disabled={loading}>{loading ? "Loading…" : "Refresh"}</button></div>
