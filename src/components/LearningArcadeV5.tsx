...
import NovaMillionaire from "./NovaMillionaire";
...
const INFO: Record<LiveGame, GameInfo> = {
  ...
  logic: { minAgeRank:1, lockedLabel:"AGE 6+", description:"Take the spotlight in an untimed reasoning show built around patterns, sequences, classification and deduction.", tags:["Reasoning","Knowledge show","Untimed"] },
...
export default function LearningArcadeV5() {
  ...
  if(round&&data?.selected){
    ...
    switch(game){
      ...
      case "logic":gameView=<NovaMillionaire {...common}/>;break;
