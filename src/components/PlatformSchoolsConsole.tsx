...
export default function PlatformSchoolsConsole({ overview }: { overview: Overview }) {
  ...
  return <div className="platform-page-stack">
    <section className="platform-page-header">
      <div><span className="platform-eyebrow">Network directory</span><h2>Schools</h2></div>
    ...
    <section className="app-card app-panel platform-start-banner"><div><span className="platform-eyebrow">NEW ACCOUNT</span><h3>Bring a school onto SukuuNova</h3></div>{canOnboard ? <Link href="/platform/schools/new" className="app-action"><Plus size={14}/><strong>Add a school</strong>Begin guided setup</Link> : <span className="app-pill">Requires schools.manage</span>}</section>
