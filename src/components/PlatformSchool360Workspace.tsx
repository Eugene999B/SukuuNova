...
export default function PlatformSchool360Workspace({
  ...
  return <div className="platform-school360-shell">
    ...
    <section className="platform-school360-commandbar">
      <div><span className="app-eyebrow">OPERATOR BRIEF</span><h2>{attentionCount ? `${attentionCount} item${attentionCount === 1 ? "" : "s"} need attention` : "School is operating normally"}</h2></div>
    ...
    <div className="platform-school360-section-heading"><div><span className="app-eyebrow">WORKSPACES</span><h2>Go straight to the job</h2></div></div>
    ...
    <div className="platform-school360-main-grid">
      <section className="app-card platform-school360-panel"><div className="platform-school360-panel-head"><div><span className="app-eyebrow">ATTENTION</span><h2>What needs a decision?</h2></div></div><div className="platform-school360-attention-list">
