...
export default function ReportCardPrintStudio({ data }: { data: Data }) {
  ...
  const brand = data.school.brandColors && typeof data.school.brandColors === "object" && !Array.isArray(data.school.brandColors)
    ...
    : {};
  const primary = color(brand.primary, "var(--color-text-secondary)");
  const accent = color(brand.accent, "var(--color-border)");
  ...
  return (
    <main className={`report-card-studio style-${style}`} style={{ ["--report-primary" as string]: primary, ["--report-accent" as string]: accent }}>
      <style data-report-card-print>{`
        :root{--report-primary:${primary};--report-accent:${accent};--report-ink:var(--color-surface-soft);--report-muted:var(--color-text-muted);--report-border:var(--sn-line);--report-soft:var(--color-bg-subtle)}
        .report-card-studio{min-height:100vh;background:var(--sn-surface);color:var(--sn-ink);padding:28px}
        .studio-bar{max-width:1240px;margin:0 auto 18px;display:flex;justify-content:space-between;gap:20px;align-items:flex-start}.studio-title small{font-size:9px;letter-spacing:.17em;font-weight:900;color:var(--sn-ink)}.studio-title h1{margin:5px 0 6px;font-size:27px;letter-spacing:-.035em}.studio-title p{margin:0;color:var(--sn-ink);font-size:11px;line-height:1.6;max-width:760px}.studio-controls{display:flex;flex-wrap:wrap;gap:7px;justify-content:flex-end}.studio-controls button{border:1px solid var(--sn-line);background:var(--sn-surface);color:var(--sn-ink);border-radius:10px;padding:9px 11px;font-size:8px;font-weight:850}.studio-controls button.active,.studio-controls button.primary{background:var(--report-primary);border-color:var(--report-primary);color:var(--sn-ink)}.studio-controls button.primary{padding-inline:15px}.style-picker{max-width:1240px;margin:0 auto 18px;display:grid;grid-template-columns:repeat(3,1fr);gap:9px}.style-card{border:1px solid var(--sn-line);background:var(--sn-surface);border-radius:13px;padding:12px;text-align:left;color:var(--sn-ink)}.style-card.active{border-color:var(--report-primary);box-shadow:0 0 0 1px var(--report-primary) inset}.style-card strong{display:block;color:var(--sn-ink);font-size:10px}.style-card span{display:block;margin-top:4px;font-size:8px;line-height:1.45;color:var(--sn-ink)}.paper-stage{max-width:1240px;margin:0 auto;padding:18px;border:1px solid var(--sn-line);border-radius:18px;background:var(--sn-surface);overflow:auto}.stage-label{font-size:8px;letter-spacing:.16em;font-weight:900;color:var(--sn-ink);margin:0 0 10px;text-transform:uppercase}.paper-frame{background:var(--sn-surface);padding:24px;min-width:760px}.ghana-report-paper{width:210mm;min-height:297mm;margin:0 auto;background:var(--sn-surface);color:var(--report-ink);padding:14mm;box-shadow:0 12px 35px var(--sn-shadow-sm);font-family:Arial,Helvetica,sans-serif}.report-export .ghana-report-paper{box-shadow:none;margin:0 auto}.school-head{display:grid;grid-template-columns:78px 1fr 92px;gap:14px;align-items:center}.school-logo{width:76px;height:76px;border:1px solid var(--report-border);display:grid;place-items:center;overflow:hidden;background:var(--sn-surface)}.school-logo img{width:100%;height:100%;object-fit:contain}.school-logo.empty:after{content:"SCHOOL CREST";font-size:7px;color:var(--sn-ink);text-align:center}.school-copy{text-align:center}.school-copy .kicker{font-size:8px;letter-spacing:.18em;font-weight:900;text-transform:uppercase;color:var(--report-primary)}.school-copy h2{font-family:Georgia,"Times New Roman",serif;margin:3px 0 2px;font-size:20px;line-height:1.05}.school-copy h3{margin:0;font-size:12px;letter-spacing:.09em;text-transform:uppercase}.school-copy .subline{margin-top:4px;font-size:8px;color:var(--report-muted)}.report-title{text-align:center;margin:12px 0 10px}.report-title span{display:inline-block;padding:5px 12px;border:1.5px solid var(--report-primary);font-size:10px;font-weight:900;letter-spacing:.13em;text-transform:uppercase}.style-modern .school-copy h2{font-family:Arial,Helvetica,sans-serif}.style-modern .report-title span{border-radius:999px;background:var(--report-primary);color:white}.style-formal .ghana-report-paper{border:1px solid var(--sn-line);padding:12mm}.style-formal .school-copy h2{font-family:Georgia,"Times New Roman",serif;font-size:19px}.style-formal .report-title span{border-width:2px}.student-grid{display:grid;grid-template-columns:1.2fr 1fr 1fr 72px;gap:0;border:1px solid var(--report-border);margin-top:8px}.student-cell{padding:7px 8px;border-right:1px solid var(--report-border);border-bottom:1px solid var(--report-border);min-height:35px}.student-cell:nth-last-child(-n+4){border-bottom:0}.student-cell:last-child{border-right:0}.student-cell label{display:block;font-size:6.5px;text-transform:uppercase;letter-spacing:.11em;font-weight:900;color:var(--sn-ink);margin-bottom:3px}.student-cell strong{font-size:9px}.photo-cell{grid-row:span 2;display:grid;place-items:center;padding:5px;border-right:0}.photo-cell img{width:60px;height:70px;object-fit:cover;border:1px solid var(--report-border)}.photo-cell span{font-size:6px;color:var(--sn-ink);text-align:center}.section-head{margin-top:11px;background:var(--report-primary);color:var(--sn-ink);padding:6px 8px;font-size:8px;font-weight:900;letter-spacing:.12em;text-transform:uppercase}.style-modern .section-head{border-radius:6px}.style-formal .section-head{background:var(--sn-surface);color:var(--report-primary);border-top:1.5px solid var(--report-primary);border-bottom:1.5px solid var(--report-primary)}table{width:100%;border-collapse:collapse}th,td{border:1px solid var(--report-border);padding:5px 6px;font-size:7.5px}th{background:var(--report-soft);font-size:6.5px;text-transform:uppercase;letter-spacing:.08em;text-align:center}.subject-col{text-align:left;width:31%}.num{text-align:center}.result-remark{text-align:left}.style-modern th{background:var(--sn-surface);border-bottom:2px solid var(--report-primary)}.style-formal th{background:var(--sn-surface)}.summary-row td{font-weight:900;background:var(--sn-surface)}.summary-strip{display:grid;grid-template-columns:repeat(4,1fr);gap:6px;margin-top:7px}.summary-item{border:1px solid var(--report-border);padding:6px 7px}.summary-item label{display:block;font-size:6px;letter-spacing:.1em;text-transform:uppercase;color:var(--sn-ink);font-weight:900}.summary-item strong{display:block;margin-top:2px;font-size:10px}.pastoral-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:8px}.box{border:1px solid var(--report-border);min-height:58px}.box h4{margin:0;padding:5px 7px;background:var(--report-soft);font-size:7px;letter-spacing:.08em;text-transform:uppercase}.box p{margin:7px;font-size:8px;line-height:1.5;min-height:28px}.signature-grid{display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-top:16px}.signature-box{padding-top:30px;border-bottom:1px solid var(--sn-line);font-size:7px}.signature-label{font-size:6.5px;color:var(--sn-ink);margin-top:4px;text-transform:uppercase;letter-spacing:.1em}.footer-note{margin-top:10px;padding-top:7px;border-top:1px solid var(--report-border);display:flex;justify-content:space-between;gap:12px;font-size:6.5px;color:var(--sn-ink)}.watermark{margin-top:4px;text-align:center;font-size:6.5px;letter-spacing:.12em;color:var(--report-primary);opacity:.55}
        @page{size:A4;margin:0}.report-card-studio,.report-card-studio *{box-sizing:border-box}@media(max-width:900px){.report-card-studio{padding:14px}.studio-bar{flex-direction:column}.studio-controls{justify-content:flex-start}.style-picker{grid-template-columns:1fr}.paper-stage{padding:8px}.paper-frame{padding:10px}.ghana-report-paper{transform-origin:top left}}@media print{body{background:var(--sn-surface)!important}.report-card-studio{padding:0!important;background:var(--sn-surface)!important;min-height:0}.studio-bar,.style-picker,.stage-label,.paper-stage{display:block}.studio-bar,.style-picker,.stage-label{display:none!important}.paper-stage{border:0!important;padding:0!important;overflow:visible!important;background:var(--sn-surface)!important}.paper-frame{padding:0!important;min-width:0!important;background:var(--sn-surface)!important}.ghana-report-paper{box-shadow:none!important;margin:0!important;width:210mm!important;min-height:297mm!important;padding:14mm!important}.report-card-studio.style-formal .ghana-report-paper{padding:12mm!important}}
      `}</style>
      ...
      <section className="studio-bar">
        ...
        <div className="studio-controls">
          ...
          <Link href="/school/report-cards" style={{ display: "inline-flex", alignItems: "center", padding: "9px 11px", borderRadius: 10, border: "1px solid var(--color-bg)", background: "var(--color-bg)", textDecoration: "none", color: "var(--color-text-subtle)", fontSize: 8, fontWeight: 850 }}>← Report cards</Link>
        </div>
      </section>
