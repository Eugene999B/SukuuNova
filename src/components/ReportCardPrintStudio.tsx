    ...
    <main className={`report-card-studio style-${style}`} style={{ ["--report-primary" as string]: primary, ["--report-accent" as string]: accent }>
      ...
      <section className="studio-bar">
        ...
        <div className="studio-controls">
          ...
          <Link href="/school/report-cards" style={{ display: "inline-flex", alignItems: "center", padding: "9px 11px", borderRadius: 10, border: "1px solid rgba(255,255,255,.1)", background: "var(--sn-surface)", textDecoration: "none", color: "var(--sn-ink)", fontSize: 8, fontWeight: 850 }>← Report cards</Link>
        </div>
      </section>
