...
export function HomeHeader() {
  ...
  return (
    <header className="home-header">
      ...
      {open ? <button type="button" className="home-mobile-menu-backdrop" aria-label="Close navigation" onClick={() => setOpen(false)} /> : null}
      <div id="home-mobile-menu" className={`home-mobile-menu ${open ? "is-open" : ""}`} aria-hidden={!open}>
