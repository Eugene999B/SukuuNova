...
export default function PayslipPrintStudio({ data }: { data: PayslipData }) {
  ...
  return <main className="payslip-studio" style={style}>
    <style data-payslip-print>{`
      .payslip-studio{min-height:100vh;background:var(--sn-surface);color:var(--sn-ink);padding:28px;font-family:Arial,Helvetica,sans-serif}.payslip-top{max-width:980px;margin:0 auto 18px;display:flex;justify-content:space-between;gap:18px;align-items:flex-start}.payslip-top h1{margin:4px 0;font-size:28px;letter-spacing:-.035em}.payslip-top p{margin:0;max-width:650px;color:var(--sn-ink);font-size:11px;line-height:1.55}.payslip-actions{display:flex;gap:7px;flex-wrap:wrap}.payslip-actions button,.payslip-actions a{border:1px solid var(--sn-line);border-radius:10px;padding:9px 11px;background:var(--sn-surface);color:var(--sn-ink);text-decoration:none;font-size:9px;font-weight:900}.payslip-actions .primary{background:var(--document-primary);border-color:var(--document-primary);color:var(--sn-ink)}.payslip-stage{max-width:980px;margin:0 auto;padding:20px;border:1px solid var(--sn-line);border-radius:18px;background:var(--sn-surface);overflow:auto}.payslip-paper-wrap{background:var(--sn-surface);padding:22px;min-width:720px}.school-payslip-paper{width:210mm;min-height:210mm;margin:0 auto;background:var(--sn-surface);color:var(--sn-ink);padding:16mm;box-shadow:0 14px 35px var(--sn-shadow-sm);font-size:10px}.payslip-brand{display:grid;grid-template-columns:70px 1fr auto;gap:14px;align-items:center;border-bottom:3px solid var(--document-primary);padding-bottom:12px}.payslip-logo{width:66px;height:66px;border:1px solid var(--sn-line);display:grid;place-items:center;overflow:hidden}.payslip-logo img{width:100%;height:100%;object-fit:contain}.payslip-school{text-align:center}.payslip-school small{font-size:7px;letter-spacing:.16em;text-transform:uppercase;color:var(--document-primary);font-weight:900}.payslip-school h2{margin:3px 0;font-family:Georgia,"Times New Roman",serif;font-size:19px}.payslip-school span{font-size:7px;color:var(--sn-ink)}.payslip-period{text-align:right}.payslip-period span{display:block;font-size:6.5px;color:var(--sn-ink);text-transform:uppercase;letter-spacing:.1em;font-weight:900}.payslip-period strong{display:block;margin-top:3px;font-size:11px}.payslip-title{margin:12px 0 10px;text-align:center}.payslip-title span{display:inline-block;padding:5px 12px;border:1px solid var(--document-primary);border-radius:999px;color:var(--document-primary);font-size:8px;letter-spacing:.14em;text-transform:uppercase;font-weight:900}.staff-grid{display:grid;grid-template-columns:1fr 1fr;border:1px solid var(--sn-line)}.staff-grid div{padding:8px;border-right:1px solid var(--sn-line);border-bottom:1px solid var(--sn-line)}.staff-grid div:nth-child(2n){border-right:0}.staff-grid div:nth-last-child(-n+2){border-bottom:0}.staff-grid label{display:block;font-size:6px;text-transform:uppercase;letter-spacing:.1em;color:var(--sn-ink);font-weight:900;margin-bottom:3px}.staff-grid strong{font-size:9px}.pay-table{margin-top:11px;width:100%;border-collapse:collapse}.pay-table th,.pay-table td{border:1px solid var(--sn-line);padding:7px}.pay-table th{background:var(--document-accent);font-size:7px;text-transform:uppercase;letter-spacing:.08em;text-align:left}.pay-table th:last-child,.pay-table td:last-child{text-align:right}.pay-table td{font-size:8px}.net-box{display:flex;justify-content:space-between;align-items:center;margin-top:12px;padding:11px 12px;background:var(--document-primary);color:var(--sn-ink);border-radius:8px}.net-box span{font-size:8px;letter-spacing:.12em;text-transform:uppercase;font-weight:900}.net-box strong{font-size:15px}.payslip-note{margin-top:12px;padding-top:8px;border-top:1px solid var(--sn-line);display:flex;justify-content:space-between;gap:10px;color:var(--sn-ink);font-size:6.5px}.payslip-watermark{text-align:center;margin-top:5px;font-size:6px;letter-spacing:.15em;color:var(--document-primary);opacity:.5}.payslip-studio .empty-deductions{padding:12px;border:1px dashed var(--sn-line);color:var(--sn-ink);font-size:8px;text-align:center}.payslip-export .school-payslip-paper{box-shadow:none;margin:0 auto}.payslip-studio .payslip-paper-wrap{break-inside:avoid}.payslip-table-body tr{break-inside:avoid;page-break-inside:avoid}@media(max-width:760px){.payslip-studio{padding:14px}.payslip-top{flex-direction:column}.payslip-stage{padding:8px}.payslip-paper-wrap{padding:8px}.school-payslip-paper{transform-origin:top left}.payslip-actions{justify-content:flex-start}}@media print{body{background:var(--sn-surface)!important}.payslip-studio{background:var(--sn-surface)!important;padding:0!important;min-height:0}.payslip-top{display:none!important}.payslip-stage{border:0!important;padding:0!important;overflow:visible!important;background:var(--sn-surface)!important}.payslip-paper-wrap{padding:0!important;min-width:0!important;background:var(--sn-surface)!important}.school-payslip-paper{width:210mm!important;min-height:auto!important;margin:0!important;padding:14mm!important;box-shadow:none!important}.payslip-table{break-inside:auto}.payslip-table tr{break-inside:avoid;page-break-inside:avoid}@page{size:A4 portrait;margin:0}}
    `}</style>
