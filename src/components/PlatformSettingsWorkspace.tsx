    ...
    <div className="platform-settings-workspace">
      <section className="app-card app-panel platform-settings-hero">
        ...
        <div className="platform-settings-state">
          ...
          <div><strong>Protected workflow</strong></div>
        </div>
      </section>
