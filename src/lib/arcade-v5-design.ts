...
export type ArcadeProgressionMode = "endless" | "tournament" | "survival" | "contracts" | "adventure" | "expedition" | "simulation" | "campaign" | "investigation" | "studio" | "navigation" | "garden" | "ladder" | "storyboard";
...
const NODES = {
  ...
  story: ["First Frame", "Character Entrance", "Goal & Obstacle", "Action Beats", "Dialogue Booth", "Transition Cut", "Camera Lab", "Revision Room", "Rough Cut", "Premiere Night"],
...
export const ARCADE_V5_IDENTITIES: Record<ArcadeV5GameKey, ArcadeGameIdentity> = {
  ...
  "sentence-scramble": { game:"sentence-scramble", name:"Animation Story Lab", world:"Frameforge Studio", rewardName:"Frame Sparks", rewardSymbol:"▰", accent:"#2dd4bf", accent2:"#fb7185", glow:"rgba(45,212,191,.42)", canvas:"#071421", surface:"#122033", introKicker:"FRAMEFORGE STUDIO", introTitle:"Write it. Direct it. Make it move.", introCopy:"Create your own mini animation with no grades, then take untimed director missions that teach sequencing, character goals, dialogue, cause and effect, camera choices and revision.", progression:progression("storyboard","STORYBOARD JOURNEY","reel","reels",NODES.story,"Open reel","Choose a production reel","Each reel unlocks a deeper story-craft tool while characters, settings, scene briefs and edit choices remix. Free Create stays completely ungraded so imagination remains the learner's own.") },
...
export const ARCADE_SESSION_VARIETY_MIN = 18 * 12 * 10 * 10 * 8 * 8;
