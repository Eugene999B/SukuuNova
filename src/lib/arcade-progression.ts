...
const UNIVERSE_GAMES = ["math", "keyboard-ninja", "force-motion-lab", "word", "comprehension-quest", "coding-sequence", "ghana-map-master", "money-math-market", "cyber-safety", "environment-guardian"] as const;
