...
export const DEFAULT_ROLE_PERMISSIONS:Record<string,readonly PermissionKey[]>={
  ...
  "HR Officer": ["students:read","attendance:record","attendance:record_staff","attendance:view_own","attendance:staff_scan","payroll:view_own","payroll:manage","users:read","users:write","reports:generate","recruitment:manage","analytics:view","exports:staff","exports:attendance","identity_cards:manage"],
  "Admissions Officer": ["students:read","students:write","reports:generate","payroll:view_own","identity_cards:manage"],
  "Class Teacher": ["students:read","attendance:record","attendance:record_assigned","attendance:view_own","attendance:staff_scan",...TEACHING_CORE,"report_cards:submit","payroll:view_own","risk_flags:view"],
  "Subject Teacher": ["students:read",...TEACHING_CORE,"payroll:view_own"],
  "Front Desk/Gate Security": ["students:read","attendance:record","attendance:record_all","attendance:view_own","attendance:display","attendance:staff_scan","attendance:pickup_approve","visitors:log","payroll:view_own","identity_cards:manage"],
