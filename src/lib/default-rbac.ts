...
export const DEFAULT_ROLE_PERMISSIONS:Record<string,readonly PermissionKey[]>={
  ...
  "HR Officer": ["students:read","attendance:record","attendance:record_staff","attendance:view_own","payroll:view_own","payroll:manage","users:read","users:write","reports:generate","recruitment:manage","analytics:view","exports:staff","exports:attendance","identity_cards:manage"],
  "Admissions Officer": ["students:read","students:write","reports:generate","payroll:view_own","identity_cards:manage"],
  ...
  "Front Desk/Gate Security": ["students:read","attendance:record","attendance:record_all","attendance:view_own","attendance:display","attendance:pickup_approve","visitors:log","payroll:view_own","identity_cards:manage"],
