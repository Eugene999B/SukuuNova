...
const LEADERSHIP_PERMISSIONS:readonly PermissionKey[]=[
  ...
  "calendar:manage","classes:manage","attendance:record","attendance:record_all","attendance:record_staff","attendance:view_own","attendance:display","attendance:review","scores:write:all","report_cards:submit","report_cards:approve","report_cards:view",
...
const ACADEMIC_COORDINATOR_PERMISSIONS:readonly PermissionKey[]=[
  "students:read","users:read","reports:generate","calendar:manage","classes:manage","attendance:record","attendance:record_all","attendance:view_own","attendance:display","attendance:review","scores:write:all","report_cards:submit",
...
const DEPARTMENT_HEAD_PERMISSIONS:readonly PermissionKey[]=[
  "students:read","reports:generate","attendance:record","attendance:record_all","attendance:view_own","attendance:review","scores:write:all","report_cards:submit","report_cards:view","exams:manage","analytics:view","risk_flags:view","lesson_plans:review","homework:review","academic_readiness:view","guardian_alerts:view"
];
...
export const DEFAULT_ROLE_PERMISSIONS:Record<string,readonly PermissionKey[]>={
  ...
  "Front Desk/Gate Security": ["students:read","attendance:record","attendance:record_all","attendance:view_own","attendance:display","attendance:pickup_approve","visitors:log","payroll:view_own"],
