...
const LEADERSHIP_PERMISSIONS:readonly PermissionKey[]=[
  ...
  "calendar:manage","classes:manage","attendance:review","scores:write:all","report_cards:submit","report_cards:approve","report_cards:view",
  "exams:manage","library:manage","transport:view","feeding:manage","analytics:view","risk_flags:view",
...
const ACADEMIC_COORDINATOR_PERMISSIONS:readonly PermissionKey[]=[
  "students:read","users:read","reports:generate","calendar:manage","classes:manage","attendance:review","scores:write:all","report_cards:submit",
...
const DEPARTMENT_HEAD_PERMISSIONS:readonly PermissionKey[]=[
  "students:read","reports:generate","attendance:review","scores:write:all","report_cards:submit","report_cards:view","exams:manage","analytics:view","risk_flags:view","lesson_plans:review","homework:review","academic_readiness:view","guardian_alerts:view"
];
...
export const DEFAULT_ROLE_PERMISSIONS:Record<string,readonly PermissionKey[]>= {
  ...
  Principal: LEADERSHIP_PERMISSIONS,
  "Vice Principal": LEADERSHIP_PERMISSIONS,
  ...
  "Class Teacher": ["students:read","attendance:record","attendance:view_own",...TEACHING_CORE,"report_cards:submit","payroll:view_own","risk_flags:view"],
  "Subject Teacher": ["students:read",...TEACHING_CORE,"payroll:view_own"],
  "Front Desk/Gate Security": ["students:read","attendance:record","attendance:view_own","attendance:pickup_approve","visitors:log","payroll:view_own"],
