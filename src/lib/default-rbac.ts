...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, readonly PermissionKey[]> = {
  ...
  "Class Teacher": ["students:read","attendance:record","attendance:view_own","scores:write:assigned","report_cards:submit","report_cards:view","reports:generate","payroll:view_own","exams:manage","exams:take","library:manage","library:borrow","offline:sync"],
  "Subject Teacher": ["students:read","attendance:view_own","scores:write:assigned","report_cards:view","reports:generate","payroll:view_own","exams:manage","exams:take","library:manage","library:borrow","offline:sync"],
