...
export const DEFAULT_ROLE_PERMISSIONS:Record<string,readonly PermissionKey[]>={
  ...
  "HR Officer": ["students:read","attendance:record","attendance:record_staff","attendance:view_own","attendance:staff_scan","payroll:view_own","payroll:manage","users:read","users:write","reports:generate","recruitment:manage","analytics:view","exports:staff","exports:attendance","identity_cards:manage",...SUPPORT_STAFF_PERMISSIONS],
  "Admissions Officer": ["students:read","students:write","reports:generate","payroll:view_own","identity_cards:manage",...SUPPORT_STAFF_PERMISSIONS],
  "Class Teacher": ["students:read","attendance:record","attendance:record_assigned","attendance:view_own","attendance:staff_scan",...TEACHING_CORE,"report_cards:submit","payroll:view_own","risk_flags:view",...SUPPORT_STAFF_PERMISSIONS],
  "Subject Teacher": ["students:read",...TEACHING_CORE,"payroll:view_own",...SUPPORT_STAFF_PERMISSIONS],
  "Front Desk/Gate Security": ["students:read","attendance:record","attendance:record_all","attendance:view_own","attendance:display","attendance:staff_scan","attendance:pickup_approve","visitors:log","payroll:view_own","identity_cards:manage",...SUPPORT_STAFF_PERMISSIONS],
  "Transport Officer": ["students:read","payroll:view_own","transport:manage","transport:view","offline:sync",...SUPPORT_STAFF_PERMISSIONS],
