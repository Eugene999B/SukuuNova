...
- External scheduling: `.github/workflows/risk-scan.yml` calls the endpoint every six hours using `SUKUUUNOVA_APP_URL` and `RISK_SCAN_CRON_SECRET` GitHub Actions secrets.
